  ...
  var n = function t(n) {
    for (var e, o = n || {}, s = 1; s < arguments.length; s += 1) {
      ...
      if (r.length) for (var a = 0; a < r.length; a += 1) {
        var l = r[a];
        Object.prototype.hasOwnProperty.call(e, l) && (_typeof(e[l]) === "object" ? t(o[l], e[l]) : o[l] = e[l]);
      }
    }
  ...
  t.simplyCountdown = function (t, o) {
    ...
    var f = function (t) {
      var n, o = t,
        a = function (t, n) {
          var o;
          return t.inline ? (o = document.createElement("span")).classList.add(t.inlineClass) : {
      ...
      (n = function () {
        ...
        l = new Date;
        w.enableUtc ? (i = new Date(l.getFullYear(), l.getMonth(), l.getDate(), l.getHours(), l.getMinutes(), l.getSeconds()), u = (r - i.getTime()) / 1000) : u = (r - l.getTime()) / 1000;
    ...
    if (y !== null && Symbol.iterator in Object(y)) {
